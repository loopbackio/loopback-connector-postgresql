...
PostgreSQL.prototype.buildFields = function(model, data, excludeIds) {
  ...
  var compositeFields = keys.filter(function (field) {
     return props[field].postgresql.dataType === 'composite'
  });
  var fields = this._buildFieldsForKeys(model, data, keys, (excludeIds || []).concat(compositeFields));
